...
--Select the name of all products from the table.--
SELECT name FROM products;

--Select the name and price of all products from the table.--
SELECT name, price FROM products;

--Add a new product - make up whatever you would like!
INSERT INTO products (name, price, can_be_returned) VALUES ('lamp', 33.50, true);

--Display only the products that ***can_be_returned*** is true.--
...
ALTER TABLE products ALTER COLUMN can_be_returned SET NOT NULL; UPDATE products SET can_be_returned = true;